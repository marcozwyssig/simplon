...
product knowledge: `simplon.tasks.claudeplugins:install_cmd` rather than a product module that only
...
Product data reaches these callables through `simplon.context.current()` and the manifest, never through
