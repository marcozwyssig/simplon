...
{{< cards >}}
  ...
  {{< card link="examples/" title="Worked examples" subtitle="Seven real jobs, end to end: cutting a release, chasing a red suite, adding a command, deploying to one environment." >}}
