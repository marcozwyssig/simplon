...
| testing | pytest, mypy, Allure - and, for `test:walk`, a person at the terminal | `test:gate`, `test:accept`, `test:report`, `test:typecheck-python`, `test:walk`, `test:generated` |
