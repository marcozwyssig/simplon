...
| --- | --- | --- |
| diagnosis | 141 | nothing - the declaration had no working meaning |
| expression rule | 23 | something it could otherwise have said |
| **all load-time refusals** | **164** | |
...
| reach | count | meaning |
| --- | --- | --- |
| the kernel is held to it too | 17 | the same check rules on the catalogue's own declarations - over the merged tree, or over a product-owned section the kernel would go through unchanged |
