...
| --- | --- | --- |
| diagnosis | 165 | nothing - the declaration had no working meaning |
| expression rule | 28 | something it could otherwise have said |
| **all load-time refusals** | **193** | |
...
rule is asked what it was actually handed. The catalogue holds **42** coordinates and its own tree places
