...
{{< cards >}}
  {{< card link="phases/" title="The five phases" subtitle="The corset: build, test, release, deploy, monitor - what flows between them, what the catalogue offers each, and the one rib that is still empty." >}}
